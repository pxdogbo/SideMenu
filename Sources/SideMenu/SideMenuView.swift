...
public struct SideMenuView<Content:View>: View {
    ...
    public var backImage:String = "mclaren"
   ...
   public init(isMenuOpen:Binding<Bool>,tabs:[MenuTabModel] ,selectedTab:Binding<MenuTabModel>,backColor:Binding<Color>,backImage:String = "mclaren",selectionColor:Color = Color.blue,blurRadius:CGFloat = 32,enable3D:Bool = true, @ViewBuilder content: () -> Content) {
        self.tabs = tabs
   ...
   public var body: some View {
        ZStack {
            ...
            .animation(.linear(duration: 0.75), value: isMenuOpen)
